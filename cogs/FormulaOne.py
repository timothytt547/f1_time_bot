...
class FormulaOne(interactions.Extension):
    ...
    @interactions.extension_command(name="f1",
                 ...
                 options=[
                    ...
                    interactions.Option(
                        name="results",
                        description="Show this season's race results (use /f1 circuits for circuit names)",
                        type=interactions.OptionType.SUB_COMMAND,
                        options=[
                            interactions.Option(
                                name="name",
                    ...
                    # circuits: show this season's circuits (visible to user only), helper function
                    interactions.Option(
                        name="circuits",
                        description="Show the current season's race circuits",
                        type=interactions.OptionType.SUB_COMMAND,
                        options=[]
                    )
                ]
